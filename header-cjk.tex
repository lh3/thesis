...
%
%\ifPDF
%	\documentclass[pdftex,12pt,openany,twoside]{book}
...
\fancyhead[RE]{\bfseries Constructing the TreeFam Database}
...
\renewcommand{\captionfont}{\fontsize{11pt}{13.2pt}\selectfont}
